...
public interface AccountServiceInterfaceV1 {
    ...
    String BULK_INVOICES_PATH = "/bulkInvoices";
    ...
    String BULK_NONINVOICE_PATH = "/bulkNonInvoicedDetails";
    String PATH = "path";
     ...
     * @param tenantId   id of tenant where the COMPANY account exists
     * @param propertyId id of the property
     * @param accountIds  ids of COMPANY accounts to retrieve non-invoiced details from
     * @return Non-invoiced details for a COMPANY accounts
     */

    @POST
    @Path(ACCOUNT_ID_PATH + BULK_NONINVOICE_PATH)
    @PreAuthorize("hasPermission('Required', 'ReadAccountsReceivable')")
    List<NonInvoicedARDetail> getBulkNonInvoicedARDetails(@PathParam(TENANT_ID) String tenantId,
    ...
    @POST
    @Path(ACCOUNT_ID_PATH + BULK_INVOICES_PATH)
    @OkOnEmpty
    @PreAuthorize("hasPermission('Required', 'ReadAccountsReceivable')")
    Map<String, List<InvoiceView>> findBulkInvoices(@PathParam(TENANT_ID) String tenantId, @PathParam
